# C4W4_CHATBOT \\* \\*Examine some \\*unique challenges\\* Transformer models face and their \\*solutions\\*,  then \\*build a chatbot\\* using a \\*Reformer model.\\*  Learning Objectives Explain the \\*motivation for reversible layers\\* Integrate\\* locality sensitive hashing\\* into \\*attention layers\\* Describe the \\*Reformer model\\*

📊 **Progress:** `77` Notes | `119` Screenshots
