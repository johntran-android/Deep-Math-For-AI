...
**`~12,329 notes` · `~16,753 screenshots` · `19 courses`** · work in progress
...
### 📂 Bishop PRML — Pattern Recognition & ML (📝 237 Notes | 📸 317 Screenshots)
...
- [2.3.4 MLE for Gaussian](a0_bishop_prml/234_mle_for_gaussian.md) — `2n / 2i` 
