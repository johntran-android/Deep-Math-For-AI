...
**`~12,340 notes` · `~16,769 screenshots` · `19 courses`** · work in progress
...
### 📂 Bishop PRML — Pattern Recognition & ML (📝 247 Notes | 📸 332 Screenshots)
...
- [2.3.6 Bayesian inference for Gaussian](a0_bishop_prml/236_bayesian_inference_for_gaussian.md) — `3n / 5i` 
