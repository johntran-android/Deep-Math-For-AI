...
### 📂 numerical_optimization_sm (📝 27 Notes | 📸 33 Screenshots)
...
- [7.2 Limited-Memory Quasi-Newton Methods](numerical_optimization_sm/72_limited_memory_quasi_newton_methods.md) — `18n / 22i`
...
### 📂 A0_BISHOP_PRML (📝 21 Notes | 📸 32 Screenshots)

- [1.0 Into](a0_bishop_prml/10_into.md) — `8n / 8i` 
- [1.1 Example: Polynomial Curve Fitting](a0_bishop_prml/11_example_polynomial_curve_fitting.md) — `13n / 24i` 
- [1.2 Probability Theory](a0_bishop_prml/12_probability_theory.md) *(pending)* — `0n / 0i`
...
- [1.2.2 Calculus Of Probability](a0_casella/122_calculus_of_probability.md) — `8n / 12i` 
- [1.2.3 Counting](a0_casella/123_counting.md) — `6n / 10i` 
- [1.2.4 Enumerating Outcome](a0_casella/124_enumerating_outcome.md) — `5n / 9i` 
- [1.3 Conditional Probability & Independence](a0_casella/13_conditional_probability_independence.md) — `18n / 20i` 
- [1.4 Random Variables](a0_casella/14_random_variables.md) — `8n / 6i` 
...
- [7.2 Method Of Finding Estimators](a0_casella/72_method_of_finding_estimators.md) — `48n / 62i` 
