...
### 📂 numerical_optimization_sm (📝 89 Notes | 📸 113 Screenshots)
...
- [8.2 Automatic Differentiation (*extremely Important For Ai)](numerical_optimization_sm/82_automatic_differentiation_extremely_important_for_ai.md) — `31n / 41i` 
...
### 📂 A0_BISHOP_PRML (📝 146 Notes | 📸 201 Screenshots)
...
- [1.6 Information Theory](a0_bishop_prml/16_information_theory.md) — `15n / 20i` 
- [Appendix D. Calculus of Variation](a0_bishop_prml/appendix_d_calculus_of_variation.md) — `4n / 6i`
...
- [Certificate](a0_cs50x/certificate.md) *(pending)* — `0n / 1i` 
...
- [4.1 Overview](a0_isl/41_overview.md) *(pending)* — `0n / 1i` 
- [4.2 Why Not Linear Regression?](a0_isl/42_why_not_linear_regression.md) *(pending)* — `0n / 1i` 
