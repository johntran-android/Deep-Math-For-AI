...
### 📂 numerical_optimization_sm (📝 49 Notes | 📸 56 Screenshots)
...
- [8.1 Finite-Difference Derivative Approx](numerical_optimization_sm/81_finite_difference_derivative_approx.md) — `12n / 13i` 
...
### 📂 A0_BISHOP_PRML (📝 69 Notes | 📸 95 Screenshots)
...
- [1.2.5 Curve fitting re-visited.](a0_bishop_prml/125_curve_fitting_re_visited.md) *(pending)* — `0n / 0i`
