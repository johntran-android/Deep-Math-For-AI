...
### 📂 numerical_optimization_sm (📝 40 Notes | 📸 45 Screenshots)
...
- [A.1 Error Analysis & Floating-Point Arithmetic](numerical_optimization_sm/a1_error_analysis_floating_point_arithmetic.md) — `4n / 5i`
...
### 📂 A0_BISHOP_PRML (📝 41 Notes | 📸 57 Screenshots)
...
- [1.2 Probability Theory](a0_bishop_prml/12_probability_theory.md) — `20n / 29i`
