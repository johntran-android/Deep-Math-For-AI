...
### 📂 A0_BISHOP_PRML (📝 45 Notes | 📸 64 Screenshots)
...
- [1.2 Probability Theory](a0_bishop_prml/12_probability_theory.md) — `24n / 36i`
...
### 📂 numerical_optimization_sm (📝 41 Notes | 📸 46 Screenshots)
...
- [A.1 Error Analysis & Floating-Point Arithmetic](numerical_optimization_sm/a1_error_analysis_floating_point_arithmetic.md) — `5n / 6i`
