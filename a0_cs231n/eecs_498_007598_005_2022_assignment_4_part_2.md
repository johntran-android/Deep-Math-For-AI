...
📊 **Progress:** `54` Notes | `123` Screenshots
...
>
> Ngoài ra còn có **roi_size**là kích thước sẽ dùng cho bước roi pooling - là bước\*
> \*nhận các **"proposed region feature map" kết hợp từ "predicted region" từ RPN và
