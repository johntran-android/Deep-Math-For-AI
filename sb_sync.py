...
def process_sb_node(node, depth, writer, children_map, assets_src_dir, assets_dest_dir, nodes_by_id, l1_ids, stats):
    ...
    if image_path:
        ...
        if os.path.exists(src):
            ...
            img_html = f'<p align="center"><kbd><img src="assets/{real_filename}" width="80%"></kbd></p>'
    ...
    for att in attachments:
        if att.get('type') == 'image' and att.get('content'):
            ...
            if os.path.exists(att_src):
                ...
                att_html = f'<p align="center"><kbd><img src="assets/{att_filename}" width="80%"></kbd></p>'
    ...
    for l1_node in l1_nodes:
        ...
        if l1_image:
            ...
            if os.path.exists(src):
                ...
                content_buffer.write(f'<p align="center"><kbd><img src="assets/{real_filename}" width="80%"></kbd></p>\n\n')
                stats['images'] += 1
        ...
        for att in l1_attachments:
            if att.get('type') == 'image' and att.get('content'):
                ...
                if os.path.exists(att_src):
                    ...
                    content_buffer.write(f'<p align="center"><kbd><img src="assets/{att_filename}" width="80%"></kbd></p>\n\n')
                    stats['images'] += 1
    ...
    if root_content or root_image:
        ...
        with open(overview_path, 'w', encoding='utf-8') as f:
            ...
            if root_image:
                ...
                if os.path.exists(src):
                    shutil.copy2(src, os.path.join(assets_output_dir, real_filename))
                    f.write(f'<p align="center"><kbd><img src="assets/{real_filename}" width="80%"></kbd></p>\n\n')
